...
agente_PNCP = LlmAgent(
    ...
    description='Você é um agente que direciona o usuário à página Portal Nacional de Contratações Públicas - PNCP',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre Portal Nacional de Contratações Públicas - PNCP estão presentes em: https://www.gov.br/pncp/pt-br/acesso-a-informacao/painel-pncp-em-numeros/pncp-em-numeros-contratacoes/pncp-em-numeros-municipio"
