...
agente_RGF = LlmAgent(
    ...
    name='agente_RGF',
    description='Você é um agente que direciona o usuário à página de RGF',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre RGF estão presentes em: https://transparencia.go.gov.br/gestao-fiscal-e-governamental-rgf/"
