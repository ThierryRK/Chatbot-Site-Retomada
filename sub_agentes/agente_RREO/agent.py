...
agente_RREO = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_RREO',
    description='Você é um agente que direciona o usuário à página de RREO',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre RREO estão presentes em: https://transparencia.go.gov.br/rreo/"
