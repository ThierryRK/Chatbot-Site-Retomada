...
agente_SIC_fisico_unidades_vapt_vupt = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_SIC_fisico_unidades_vapt_vupt',
    description='Você é um agente que direciona o usuário à página SIC Físico – Unidades do Vapt Vupt',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre SIC Físico – Unidades do Vapt Vupt estão presentes em: https://www.go.gov.br/servicos-digitais/vapt-vupt/unidades-e-filas/unidades"
