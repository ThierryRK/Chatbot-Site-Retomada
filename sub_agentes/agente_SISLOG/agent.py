...
agente_SISLOG = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_SISLOG',
    description='Você é um agente que direciona o usuário à página SISLOG',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre SISLOG estão presentes em: https://sislog.go.gov.br/"
