...
agente_acordos_sem_recursos = LlmAgent(
    ...
    "As informações sobre os acordos de transferência sem recursos estão presentes em: https://goias.gov.br/retomada/acordos-sem-transferencia-de-recursos/"
