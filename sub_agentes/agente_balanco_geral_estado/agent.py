...
agente_balanco_geral_estado = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_balanco_geral_estado',
    description='Você é um agente que direciona o usuário à página de balanco geral do Estado',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre o balanco geral do Estado estão presentes em: https://goias.gov.br/economia/prestacao-de-contas-de-governo/"
