...
agente_bens_imoveis = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_bens_imoveis',
    description='Você é um agente que direciona o usuário à página de bens imóveis',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre os bens imóveis estão presentes em: https://www.transparencia.go.gov.br/wp-content/uploads/sites/2/painel/lai.php?painel=bens_imoveis&orgao=ser"
