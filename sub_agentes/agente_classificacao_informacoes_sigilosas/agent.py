...
agente_classificacao_informacoes_sigilosas = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_classificacao_informacoes_sigilosas',
    description='Você é um agente que direciona o usuário à página Classificação das informações sigilosas',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre a Classificação das informações sigilosas estão presentes em: https://goias.gov.br/retomada/classificacao-das-informacoes-sigilosas-2/"
