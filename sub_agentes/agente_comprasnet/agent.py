...
agente_comprasnet = LlmAgent(
    ...
    ),    name='agente_comprasnet',
    description='Você é um agente que direciona o usuário à página ComprasNet',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre ComprasNet estão presentes em: https://www.comprasnet.go.gov.br/"
