...
agente_consultas_publicas = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_consultas_publicas',
    description='Você é um agente que direciona o usuário à página de Consultas Públicas',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre Consultas Públicas da Lei estão presentes em: https://goias.gov.br/retomada/audiencias-publicas/"
