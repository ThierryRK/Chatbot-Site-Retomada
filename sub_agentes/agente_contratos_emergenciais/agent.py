...
agente_contratos_emergenciais = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_contratos_emergenciais',
    description='Você é um agente que direciona o usuário à página de contratos emergenciais',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre os contratos emergenciais estão presentes em: https://goias.gov.br/retomada/contratos-emergenciais/"
