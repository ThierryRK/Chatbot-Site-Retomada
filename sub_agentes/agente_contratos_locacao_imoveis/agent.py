...
agente_contratos_locacao_imoveis = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_contratos_locacao_imoveis',
    description='Você é um agente que direciona o usuário à página de acordos de contratos de locação de imóveis',
    instruction='''
    Sua única tarefa é:
