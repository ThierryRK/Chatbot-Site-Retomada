...
agente_convenios_concedidos = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_convenios_concedidos',
    description='Você é um agente que direciona o usuário à página de convênios concedidos',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre os convênios concedidos estão presentes em: https://goias.gov.br/retomada/convenios-concedidos/"
