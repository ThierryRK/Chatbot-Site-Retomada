...
agente_convenios_recebidos = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_convenios_recebidos',
    description='Você é um agente que direciona o usuário à página de convênios recebidos',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre os convênios recebidos estão presentes em: https://goias.gov.br/retomada/convenios-recebidos/"
