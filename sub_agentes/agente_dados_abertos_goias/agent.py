...
agente_dados_abertos_goias = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_dados_abertos_goias',
    description='Você é um agente que direciona o usuário à página de Dados Abertos Goiás',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre Dados Abertos Goiás estão presentes em: https://dadosabertos.go.gov.br/organization/secretaria-de-estado-da-retomada"
