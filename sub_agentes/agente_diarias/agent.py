...
agente_diarias = LlmAgent(
    ...
    description='Você é um agente que direciona o usuário à página de diárias',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre as diárias estão presentes em: https://www.transparencia.go.gov.br/wp-content/uploads/sites/2/painel/lai.php?painel=diarias&orgao=ser"
