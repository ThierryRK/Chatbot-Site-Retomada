...
agente_e_SIC_eletronico = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_e_SIC_eletronico',
    description='Você é um agente que direciona o usuário à página e-SIC Eletrônico',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre e-SIC Eletrônico estão presentes em: https://www.go.gov.br/servicos-digitais/cge/nova-ouvidoria/nova-manifestacao?orgao=42"
