...
agente_empenhos_pagamentos = LlmAgent(
    model=LiteLlm(model="ollama_chat/qwen2.5:14b", base_url=ollama_endpoint),
    name='agente_empenhos_pagamentos',
    description='Você é um agente que direciona o usuário ao site de empenhos e pagamentos',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre empenhos e pagamentos estão disponíveis em: https://www.transparencia.go.gov.br/wp-content/uploads/sites/2/painel/lai.php?painel=empenhos&orgao=ser"
