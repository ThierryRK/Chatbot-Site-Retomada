...
agente_encarregado_tratamento_dados_pessoais = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_encarregado_tratamento_dados_pessoais',
    description='Você é um agente que direciona o usuário à página Encarregado pelo Tratamento dos Dados Pessoais',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre o Encarregado pelo Tratamento dos Dados Pessoais estão presentes em: https://goias.gov.br/retomada/lei-geral-de-protecao-de-dados/"
