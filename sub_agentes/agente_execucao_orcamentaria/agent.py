...
agente_execucao_orcamentaria = LlmAgent(
    model=LiteLlm(model="ollama_chat/qwen2.5:14b", base_url=ollama_endpoint),
    name='agente_execucao_orcamentaria',
    description='Você é um agente que direciona o usuário ao site de execução orçamentária',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre a execução orçamentária estão disponíveis em: https://www.transparencia.go.gov.br/wp-content/uploads/sites/2/painel/lai.php?painel=execucao_orcamentaria_visao_geral&orgao=ser"
