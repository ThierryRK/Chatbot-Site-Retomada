...
agente_expresso_goias = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_expresso_goias',
    description='Você é um agente que direciona o usuário à página Expresso Goiás',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre Expresso Goiás estão presentes em: https://www.go.gov.br/"
