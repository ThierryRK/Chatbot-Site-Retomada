...
agente_folha_de_pagamento = LlmAgent(
    model=LiteLlm(
    ...
    ),    name='agente_folha_de_pagamento',
    description='Você é um agente que direciona o usuário à página de folha de pagamento',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre a folha de pagamento estão presentes em: https://www.transparencia.go.gov.br/wp-content/uploads/sites/2/painel/lai.php?painel=folha_de_pagamento_salarios_de_servidores_ativos&orgao=ser"
