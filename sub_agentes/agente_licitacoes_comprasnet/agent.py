...
agente_licitacoes_comprasnet = LlmAgent(
    ...
    "As informações sobre as Licitações – Comprasnet estão presentes em: https://www.transparencia.go.gov.br/wp-content/uploads/sites/2/painel/lai.php?painel=licitacoes_licitacoes_concluidas&orgao=ser"
