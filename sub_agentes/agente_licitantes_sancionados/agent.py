...
agente_licitantes_sancionados = LlmAgent(
    model=LiteLlm(
    ...
    ),    name='agente_licitantes_sancionados',
    description='Você é um agente que direciona o usuário à página de Licitantes Sancionados Administrativamente',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre os Licitantes Sancionados Administrativamente estão presentes em: https://transparencia.go.gov.br/fornecedores-impedidos/"
