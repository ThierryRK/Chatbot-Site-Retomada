...
agente_lista_estagiarios = LlmAgent(
    ...
    "As informações sobre a lista de estagiários estão presentes em: https://www.transparencia.go.gov.br/wp-content/uploads/sites/2/painel/lai.php?painel=folha_de_pagamento_salarios_de_estagiarios_ativos&orgao=ser"
