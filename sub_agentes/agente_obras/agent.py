...
agente_obras = LlmAgent(
    ...
    name='agente_obras',
    description='Você é um agente que direciona o usuário à página de obras',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre as obras estão presentes em: https://app.powerbi.com/view?r=eyJrIjoiZjdhNDMxYjQtNDg3ZC00NjQ1LWI5M2EtMGRhMzg2OTNmMWZhIiwidCI6IjY3ZmQ0MzFjLWIyYWQtNDg2Ny04MWJjLWQ3NTYyMjBiNTZkNCJ9&pageName=ReportSectiond755217298c2706b71dc"
