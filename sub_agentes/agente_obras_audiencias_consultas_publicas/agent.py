...
agente_obras_audiencias_consultas_publicas = LlmAgent(
    model=LiteLlm(
    ...
    name='agente_obras_audiencias_consultas_publicas',
    description='Você é um agente que direciona o usuário à página de obras - audiências/consultas públicas',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre as obras - audiências/consultas públicas estão presentes em: https://goias.gov.br/retomada/obras-audiencias-consultas-publicas/"
