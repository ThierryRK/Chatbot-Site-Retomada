...
agente_ouvidoria_atendimento_presencial = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_ouvidoria_atendimento_presencial',
    description='Você é um agente que direciona o usuário à página Ouvidoria – Atendimento Presencial',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre Ouvidoria – Atendimento Presencial estão presentes em: https://goias.gov.br/retomada/atendimento-presencial-ouvidoria/"
