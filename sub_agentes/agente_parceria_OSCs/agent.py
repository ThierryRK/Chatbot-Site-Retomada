...
agente_parceria_OSCs = LlmAgent(
    ...
    name='agente_parceria_OSCs',
    description='Você é um agente que direciona o usuário à página de parcerias com OSCs',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre as parcerias com OSCs estão presentes em: https://goias.gov.br/retomada/parcerias-com-oscs/"
