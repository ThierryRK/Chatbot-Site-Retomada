...
agente_pesquisa_satisfacao = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_pesquisa_satisfacao',
    description='Você é um agente que direciona o usuário à página Pesquisa de Satisfação',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre Pesquisa de Satisfação estão presentes em: https://app.powerbi.com/view?r=eyJrIjoiNmRhN2MzZmYtMWZkMi00ODdmLWJhNGQtYTJkODcwNDJlMTU4IiwidCI6IjY3ZmQ0MzFjLWIyYWQtNDg2Ny04MWJjLWQ3NTYyMjBiNTZkNCJ9"
