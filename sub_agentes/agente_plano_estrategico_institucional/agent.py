...
agente_plano_estrategico_institucional = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_plano_estrategico_institucional',
    description='Você é um agente que direciona o usuário à página de plano estratégico institucional',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre o plano estratégico institucional estão presentes em: https://goias.gov.br/retomada/planejamento-estrategico-e-diversos/"
