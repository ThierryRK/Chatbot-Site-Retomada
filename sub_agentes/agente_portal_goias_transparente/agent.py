...
agente_portal_goias_transparente = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_portal_goias_transparente',
    description='Você é um agente que direciona o usuário à página Portal Goiás Transparente',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre Portal Goiás Transparente estão presentes em: https://transparencia.go.gov.br/"
