...
agente_projetos_inovacao_servico_publico = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_projetos_inovacao_servico_publico',
    description='Você é um agente que direciona o usuário à página de Projetos de Inovação no Serviço Público',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre a Projetos de Inovação no Serviço Público estão presentes em: https://goias.gov.br/retomada/projetos-de-inovacao-no-servico-publico-4/"
