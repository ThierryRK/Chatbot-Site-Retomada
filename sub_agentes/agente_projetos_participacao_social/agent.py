...
agente_projetos_participacao_social = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_projetos_participacao_social',
    description='Você é um agente que direciona o usuário à página de Projetos de Participação Social',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre Projetos de Participação Social estão presentes em: https://goias.gov.br/retomada/wp-content/uploads/sites/22/2025/09/SEI_GOVERNADORIA-78969364-Declaracao.pdf"
