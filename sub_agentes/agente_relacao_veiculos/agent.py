...
agente_relacao_veiculos = LlmAgent(
    model=LiteLlm(model="ollama_chat/ministral-3:14b", base_url=ollama_endpoint),
    name='agente_relacao_veiculos',
    description='Você é um agente que direciona o usuário à página de relação de veículos',
    instruction='''
    Sua única tarefa é:
    1. Responder a seguinte frase ao usuário:
    "As informações sobre a relação de veículos estão presentes em: https://goias.gov.br/retomada/wp-content/uploads/sites/22/2025/06/Planilha_frota_2025.pdf"
