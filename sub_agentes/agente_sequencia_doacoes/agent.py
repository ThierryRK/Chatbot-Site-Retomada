...
from sub_agentes.agente_sequencia_doacoes.sub_agentes_sequencia.agente_extrator_de_conteudo_pagina_web_2.agent import \
    agente_extrator_de_conteudo_pagina_web_2

agente_sequencia_doacoes = SequentialAgent(
    name="agente_sequencia_doacoes",
    sub_agents=[agente_extrator_de_conteudo_pagina_web_2, agente_de_resumos],
